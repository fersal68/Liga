...
function inmodal() {
    ...
    document.getElementById("amountv1").value = 0;
...
// aca muevo el resultado a un campo aculto, esto es para que el AJAX lo pase al siguiente formulario con metodo post
   ...
   // con este ajax carla en siguiente php con metodo post
        var url = "./ModalcargaresultadoSQL.php";
        $.ajax({                        
           type: "POST",                 
           url: url,                     
...
<form  method="POST" name="Form_add_solicit"  id="formulariocarga" autocomplete="on" enctype="multipart/form-data" target="Objetivo_Subida" 
class="ModalFormVs"  
>
